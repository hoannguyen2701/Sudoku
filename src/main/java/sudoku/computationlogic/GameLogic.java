...
public class GameLogic {
    ...
    public static GameStage CheckForCompletion(int[][] grid){
        if (sudokuIsInvalid(grid)) return GameStage.ACTIVE;
        if (tileAreNotFilled(grid)) return GameStage.ACTIVE;
    ...
    public static boolean rowAreInvalid(int[][] grid) {
